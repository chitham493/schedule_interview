$('#job_vacancy_table').DataTable( {
  ...
  { title:'Id',name:"JobVacancyId",class: "job_vacancy_list_column" },
  { title:'JobPosition',name:"JobPosition",class: "job_vacancy_list_column" },
  { title:'JobCode',name:"JobCode",class: "job_vacancy_list_column" },
  { title:'Vacancy',name:"Vacancy",class: "job_vacancy_list_column" },
  {
    title: "Action",
    orderable: false,
    data: null,

...
<html lang="en">
   <head>
      <title>interview_types List</title>
            ...
            <section class="col-xs-12 col-md-10">
               ...
               <div id="content_real">
                  <div id="content_layout">
                     <div class="top_tabelements row">
                        ...
                        <div class="col-lg-5">
                           <div class="row">
                              <div class="col-sm-6">
                                 <div class="row">
                                    <div class="add_interview_types_but col-xs-5">
                     ...
                     <main class="table">
                        <table id="interview_types_list" class="table table-responsive">
                        </table>
                     </main>
                  </div>
               </div>

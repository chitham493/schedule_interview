   ...
   <body class="dev_login">
      <div class="login-page">         
         ...
         <form class="form_dev" action="<cfoutput> #application.domain_name#</cfoutput>login/cfc/logindb.cfc?method=logindb" name="login1" method="post">
            ...
            <div class="login_image_hand"><img alt="crm"  src="Assets/images/developers.png" class="users_imlogo" id="img_lgsk"> 
               <input type="radio" name="check_logger" value="admin">
            </div>
           <div class="login_image_hand">
               <img alt="crm"  src="Assets/images/ic_user_color.png" class="users_imlogo" id="img_lgs"> 
               <input type="radio"  name="check_logger"  value="users" checked >
            </div>
